    ...
    <div style={{
      ...
      {!selectedProfile && !editing && (
        <button
          ...
          style={{ ...s.btnSmall, marginTop: 16, width: "100%" }}
        >
          Editar perfil
        </button>
      )}

      {/* EDIT FORM (ONLY SELECTS FOR COUNTRY + GENDER) */}
      {!selectedProfile && editing && (
        <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 16 }}>
          ...
          <button style={{ ...s.btn, ...s.btnPrimary }} onClick={saveProfile}>
            Guardar
          </button>

          <button style={s.btnLink} onClick={() => setEditing(false)}>
            Cancelar
          </button>
        </div>
      )}
